...
from dwarfsquad.lib.export.export_lots_and_levels import build_lot_rows, get_lot_level_keys
...
def get_workbook(ac):
    ...
    if lot_rows:
        lots_levels_worksheet.append([k for k in get_lot_level_keys(lot_rows)])
